...
const BusinessDetials = ({ navigation: { goBack } }) => {
  return (
    <SafeAreaView style={{ flex: 1, marginTop: 20, padding: 20, }}>
      <View>
        <View style={styles.headingContainer}>
          ...
          <Text style={styles.heading}>Shopping Club</Text>
          <View>
            <Text>Share</Text>
          </View>
        </View>
        <View>
          <ImageBackground
            ...
            resizeMode="contain"
            source={{
              uri: "https://images.unsplash.com/photo-1457131760772-7017c6180f05?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1706&q=80",
            }}
          >
